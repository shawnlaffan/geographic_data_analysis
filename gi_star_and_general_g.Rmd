...
if (file.exists (output_db)) {
  ...
  if (any(output_layer_name %in% existing_layers)) {
    ...
    message ("You will need to change the output layer name, set overwrite layer to TRUE, or delete that layer before saving the results (if it is not longer needed)")
  }
}
